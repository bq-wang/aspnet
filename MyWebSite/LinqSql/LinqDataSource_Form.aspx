...
<body>
    ...
    <div>
        <%--  1. in this post, we will watch an example where the data source steming from LinqDataSource 
            ...
            4. Validation: enforce certain rules before updating, check the notes with "Validation"
        ...
        <%-- 
            Validation:
                DataKeyNames are significant for the DetailsView --%>
        <asp:DetailsView ID="detailsEmployee" runat="server" Height="50px" Width="125px" DataSourceID="sourceSingleEmployee" AutoGenerateEditButton="true" AutoGenerateInsertButton="true" AutoGenerateDeleteButton="true"
            OnItemUpdated="detailsEmployee_ItemUpdated"
        ...
        <%--
            Validation:
                EnableUpdate has to turn on in order for view to update the Source 
             in order for the details view to update, need the EnableUpdate property set to "true" --%>
        <asp:LinqDataSource 
