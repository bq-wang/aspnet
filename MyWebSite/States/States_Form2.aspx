<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="States_Form2.aspx.cs" Inherits="MyWebSite.States.States_Form2" Trace="true" ViewStateEncryptionMode="Always" %>
...
<body>
    ...
    <tr><td><asp:Button ID="btnSave" runat="server" OnClick="btnSaveClick" Text="save"/></td><td><asp:Button ID="btnRestore" runat="server" OnClick="btnRestoreClick" Text="Restore" /></td><td><asp:Button ID="btnDisplay" runat="server" OnClick="btnDisplayClick" Text="Display"/></td></tr>
    </table>
