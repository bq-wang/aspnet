...
<body>
    ...
    <div>
      ...
      <!-- to support delete feature -->
      <asp:SqlDataSource ID="sourceEmployees4" runat="server" ProviderName="System.Data.SqlClient" ConnectionString="<%$ ConnectionStrings:Northwind %>" 
        SelectCommand="SELECT EmployeeID, FirstName, LastName, Title, City FROM Employees"
        DeleteCommand="DELETE Employees WHERE EmployeeID=@EmployeeID" >
        </asp:SqlDataSource>
        <asp:GridView runat="server" DataSourceID="sourceEmployees4" ID="gridView4" AutoGenerateDeleteButton="true" DataKeyNames="EmployeeID"/>

        <br /><br />

      <!-- to support insertion feature -->
      <asp:SqlDataSource ID="sourceEmployees5" runat="server" ProviderName="System.Data.SqlClient" ConnectionString="<%$ ConnectionStrings:Northwind %>" 
        SelectCommand="SELECT EmployeeID, FirstName, LastName, Title, City FROM Employees"
        InsertCommand="INSERT INTO Employees (FirstName, LastName, Title, City) VALUES (@FirstName, @LastName, @Title, @City)" >
        </asp:SqlDataSource>
        <asp:DetailsView runat="server" DataSourceID="sourceEmployees5" ID="gridView5" AutoGenerateInsertButton="true" />
        <br /><br />
